...
public class CarController {
    ...
    public String viewCars(Model model) {
        ...
        return "cars";  // Thymeleaf template for listing cars
    }

    @GetMapping("/add")
    public String showAddForm(Model model) {
        model.addAttribute("car", new Car ());
        return "add_car";  // Thymeleaf form for adding a car
    }
    ...
    public String showEditForm(@RequestParam int id, Model model) {
        ...
        return "edit_car";  // Thymeleaf form for editing a car
    }

    // Handle update after editing
    @PostMapping("/update")
    public String updateCar(@ModelAttribute Car car) {
        carService.updateCar(car.getCarId(), car);  // ✅ fixed
        return "redirect:/";
    }
